Welcome to Ourstudio.IdentityServer!
=============================================

.. image:: images/logo.png
   :align: center

Ourstudio.IdentityServer is an OpenID Connect and OAuth 2.0 framework for ASP.NET Core, based on the fantastic `IdentityServer4 <https://github.com/IdentityServer/IdentityServer4>`_.
