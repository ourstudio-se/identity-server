...
For databases we provide support for `Entity Framework Core <https://github.com/ourstudio-se/identity-server/tree/main/src/Ourstudio.IdentityServer.EntityFramework>`_ based databases.
