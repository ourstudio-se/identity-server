...
using Ourstudio.IdentityServer.EntityFramework.Extensions;
using Ourstudio.IdentityServer.EntityFramework.Interfaces;
using Ourstudio.IdentityServer.EntityFramework.Options;
using Microsoft.EntityFrameworkCore;

namespace Ourstudio.IdentityServer.EntityFramework.DbContexts
{
    /// <summary>
    /// DbContext for the IdentityServer operational data.
    /// </summary>
    /// <seealso cref="Microsoft.EntityFrameworkCore.DbContext" />
    /// <seealso cref="Ourstudio.IdentityServer.EntityFramework.Interfaces.IPersistedGrantDbContext" />
