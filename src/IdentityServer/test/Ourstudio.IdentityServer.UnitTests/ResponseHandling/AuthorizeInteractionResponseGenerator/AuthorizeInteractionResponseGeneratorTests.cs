...
namespace Ourstudio.IdentityServer.UnitTests.ResponseHandling.AuthorizeInteractionResponseGenerator
{
    public class AuthorizeInteractionResponseGeneratorTests
    {
        ...
        private Ourstudio.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator _subject;
        ...
        {
            _subject = new Ourstudio.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator(
                _clock,
