...
namespace Ourstudio.IdentityServer.UnitTests.Endpoints.Results
{
    public class AuthorizeResultTests
    {
        ...
        private MockMessageStore<Ourstudio.IdentityServer.Models.ErrorMessage> _mockErrorMessageStore = new MockMessageStore<Ourstudio.IdentityServer.Models.ErrorMessage>();
