...
using Xunit;
using static Ourstudio.IdentityServer.Constants;

namespace Ourstudio.IdentityServer.UnitTests.Hosting
{
    public class EndpointRouterTests
    {
        private Dictionary<string, Ourstudio.IdentityServer.Hosting.Endpoint> _pathMap;
        private List<Ourstudio.IdentityServer.Hosting.Endpoint> _endpoints;
        private IdentityServerOptions _options;
        private EndpointRouter _subject;

        public EndpointRouterTests()
        {
            _pathMap = new Dictionary<string, Ourstudio.IdentityServer.Hosting.Endpoint>();
            _endpoints = new List<Ourstudio.IdentityServer.Hosting.Endpoint>();
        ...
        {
            Action a = () => new Ourstudio.IdentityServer.Hosting.Endpoint("ep1", "ep1", typeof(MyEndpointHandler));
        ...
        {
            _endpoints.Add(new Ourstudio.IdentityServer.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new Ourstudio.IdentityServer.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new Ourstudio.IdentityServer.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new Ourstudio.IdentityServer.Hosting.Endpoint("ep1", "/ep1", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new Ourstudio.IdentityServer.Hosting.Endpoint(EndpointNames.Authorize, "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new Ourstudio.IdentityServer.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
