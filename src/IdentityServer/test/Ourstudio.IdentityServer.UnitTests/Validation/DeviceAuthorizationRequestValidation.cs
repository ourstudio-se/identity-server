...
using IdentityModel;
using Ourstudio.IdentityServer.UnitTests.Validation.Setup;
using Ourstudio.IdentityServer;
using Ourstudio.IdentityServer.Models;
using Ourstudio.IdentityServer.Validation;
using Xunit;

namespace Ourstudio.IdentityServer.UnitTests.Validation
{
    public class DeviceAuthorizationRequestValidation
    {
        ...
        public async Task Invalid_Protocol_Client()
        {
            ...
            var validator = Factory.CreateDeviceAuthorizationRequestValidator();
            var result = await validator.ValidateAsync(testParameters,
        ...
        public async Task Valid_OpenId_Request()
        {
            ...
            result.ValidatedRequest.ValidatedResources.Resources.IdentityResources.Should()
                .Contain(x => x.Name == "openid");
