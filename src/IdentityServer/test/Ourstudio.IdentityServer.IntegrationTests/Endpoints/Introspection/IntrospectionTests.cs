...
using Ourstudio.IdentityServer.IntegrationTests.Endpoints.Introspection.Setup;
using Xunit;

namespace Ourstudio.IdentityServer.IntegrationTests.Endpoints.Introspection
{
    public class IntrospectionTests
    {
        ...
        public async Task Response_data_should_be_valid_using_single_scope()
        {
            ...
            var values = introspectionResponse.Json.Deserialize(typeof(Dictionary<string, JsonElement>)) as Dictionary<string, JsonElement>;
