...
using Ourstudio.IdentityServer.Configuration.DependencyInjection;
...
using Ourstudio.IdentityServer.Hosting.FederatedSignOut;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IdentityServerBuilderExtensionsCore
    {
            ...
            where T : class, IEndpointHandler
        {
            ...
            builder.Services.AddSingleton(new Ourstudio.IdentityServer.Hosting.Endpoint(name, path, typeof(T)));
