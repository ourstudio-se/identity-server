...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class IdentityServerApplicationBuilderExtensions
    {
        ...
        internal static void Validate(this IApplicationBuilder app)
        {
            ...
            var logger = loggerFactory.CreateLogger("Ourstudio.IdentityServer.Startup");
            logger.LogInformation("Starting Ourstudio.IdentityServer version {version}", typeof(Ourstudio.IdentityServer.Hosting.IdentityServerMiddleware).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion);
